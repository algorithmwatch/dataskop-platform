...
docker-compose -f docker-compose.production.yml run -u root --rm django bash -c "cp -r /home/django/.gnupg /root/.gnupg && python manage.py dbbackup --encrypt --compress --clean"
