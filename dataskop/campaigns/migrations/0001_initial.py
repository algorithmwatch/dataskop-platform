    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('draft', 'draft'), ('active', 'active'), ('inactive', 'inactive')], default='draft', max_length=100, no_check_for_status=True)),
        ...
        migrations.CreateModel(
            ...
            bases=(simple_history.models.HistoricalChanges, dataskop.campaigns.models.StatusOptions, models.Model),
        ),
        migrations.CreateModel(
            name='Donation',
            fields=[
